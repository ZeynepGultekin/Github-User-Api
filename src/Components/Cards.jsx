      ...
      <Row xs={1} lg={2} xl={3}>
        ...
        <Col>
          <Card>
            ...
            />
            <Card.Body>
              <Card.Title>Fetch Data from the Github API with React</Card.Title>
              <Card.Text>
                In this tutorial, you are creating an App using the Github API
                to fetch data and Some Application.
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <small className="text-muted">
        ...
        <Col>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                You can find the most asked questions about github api on
                Stackoverflow here
              </Card.Text>
            </Card.Body>
            <Card.Footer>
